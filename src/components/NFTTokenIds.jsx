...
function NFTTokenIds({ inputValue, setInputValue }) {
  ...
  const { NFTTokenIds, totalNFTs } = useNFTTokenIds(inputValue);
  const [visible, setVisibility] = useState(false);
  const [nftToBuy, setNftToBuy] = useState(null);
  const [loading, setLoading] = useState(false);
  const contractProcessor = useWeb3ExecuteFunction();
  const { chainId, marketAddress, contractABI, walletAddress } = useMoralis();
          ...
          <div style={styles.banner}>
            ...
            <div style={styles.text}>
              <>
                ...
                <div style={{ fontSize: "15px", color: "#9c9c9c", fontWeight: "normal", }}>
